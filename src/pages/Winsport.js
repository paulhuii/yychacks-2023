const Winsport = () => {
    return (
        <>
                ...
                <button class="sport"> <a href="vr_video.mp4">
                Video </a></button>
                    
                    
                <br></br>

                <button class="sport"> <a href="https://www.winsport.ca/tickets-passes-and-rentals/single-use-day-tickets/tube-park-tickets/">
                Buy Ski Tickets! </a></button>
